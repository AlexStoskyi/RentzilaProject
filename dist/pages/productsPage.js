...
class ProductPage {
    ...
    get searchTenderField() {
        return this.page.locator('//div[starts-with(@class, "Navbar_searchWrapper")]');
    }
    get searchTenderPlaceholder() {
        return this.page.locator('//div[starts-with(@class, "ItemSearch_search")]/input');
    }
    get fieldMap() {
        return this.page.locator('//div[@id="map"]');
    }
    get unitItem() {
        return this.page.locator('//div[starts-with(@class, "UnitCard_cardWrapper__JIPt3")][1]');
    }
    get filterCheckbox() {
        return this.page.locator('//div[starts-with(@class, "CheckboxService_radio")]/input');
    }
    get serviceInUnit() {
        return this.page.locator('//div[starts-with(@class, "ImageWithDescription_main")]');
    }
    get filterBar() {
        return this.page.locator('data-testid="filterForm"');
    }
    get selectedFiltersField() {
        return this.page.locator('//div[starts-with(@class, "ResetFilters_selectedCategory")]');
    }
    get buildFilterField() {
        return this.page.locator('//input[@id="serviceCategory-3"]');
    }
    get checkBoxName() {
        return this.page.locator('//div[starts-with(@class, "CheckboxService_radio")]/label');
    }
    get dropDownButtonOfAgricultural() {
        return this.page.locator('//div[starts-with(@class, "ServiceCategory_category_container")][1]/div[@data-testid="rightArrow"]');
    }
    get dropDownAgriculturalContent() {
        return this.page.locator('//div/label[@for="radio-3-0"]');
    }
    get dropDownButtonOfBuilding() {
        return this.page.locator('//div[starts-with(@class, "ServiceCategory_category_container")][2]/div[@data-testid="rightArrow"]');
    }
    ...
    async getTextSearchPlaceholder() {
        const placeholder = await this.searchPlaceholder.getAttribute('placeholder');
        return placeholder;
    }
    async searchTenderFieldIsVisible() {
        return this.searchTenderField.isVisible();
    }
    async getTextSearchTenderPlaceholder() {
        const placeholder = await this.searchTenderPlaceholder.getAttribute('placeholder');
        return placeholder;
    }
}
