...
exports.FooterPage = exports.FooterLinks = void 0;
class FooterLinks {
    page;
    constructor(page) {
        this.page = page;
    ...
    get privacyPolicyBody() {
        return this.page.locator('//div[starts-with(@class, "PrivacyPolicy_container")]');
    }
    get cookiesContainerBody() {
        return this.page.locator('//div[starts-with(@class, "Cookies_container")]');
    }
    get userAgreementBody() {
        return this.page.locator('//div[starts-with(@class, "TermsConditions_content")]');
    }
}
...
class FooterPage {
    ...
    get cookieRulesField() {
        return this.page.locator('//div[@data-testid="pravila-vikoristannya-failiv-cookie"]');
    }
    get termsField() {
        return this.page.locator('//div[@data-testid="umovi-dostupu-ta-koristuvannya"]');
    }
    get userField() {
        return this.page.locator('//div[starts-with(@class, "RentzilaForBuyers_container")]/div[starts-with(@class, "RentzilaForBuyers_title")]');
    }
    get announcementField() {
        return this.page.locator('//div[starts-with (@class, "RentzilaForBuyers_link")]/a[@href="/products/"]');
    }
    get tendersField() {
        return this.page.locator('//div[starts-with (@class, "RentzilaForBuyers_link")]/a[@href="/tenders-map/"]');
    }
    get jobRequestsField() {
        return this.page.locator('//div[starts-with (@class, "RentzilaForBuyers_link")]/a[@href="/requests-map/"]');
    }
    get contactsField() {
        return this.page.locator('//div[starts-with(@class,"RentzilaContacts_title")]');
    }
    get emailField() {
        return this.page.locator('//div[starts-with(@class,"RentzilaContacts_container")]');
    }
    get footerLogo() {
        return this.page.locator('//div[starts-with(@class,Footer_footer)]/div[@data-testid="logo"]');
    }
